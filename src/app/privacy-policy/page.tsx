...
export const metadata: Metadata = {
  title: 'Privacy Policy | Raj Electronics',
  description: 'Privacy Policy and Data Protection guidelines for Raj Electronics',
};

export default function PrivacyPolicy() {
  return (
    <div className="container mx-auto px-4 py-12 max-w-4xl">
      <h1 className="text-3xl md:text-4xl font-bold mb-8 text-slate-900 border-b pb-4">Privacy Policy</h1>
      
      <div className="prose prose-slate max-w-none text-slate-700 space-y-6">
        <h2 className="text-xl font-semibold text-slate-900">Introduction</h2>
        <p>
          This Privacy Policy describes how <strong>Raj Electronics</strong> and its affiliates (collectively "we, our, us")
          collect, use, share, protect or otherwise process your information/ personal data through our website
          https://rajelectronics.co/ (hereinafter referred to as Platform). Please note that you may be able to
        ...
        <h2 className="text-xl font-semibold text-slate-900 mt-8">Collection</h2>
        <p>
        ...
        <p>
          If you receive an email or a call from a person/association claiming to be <strong>Raj Electronics</strong>
        ...
        <h2 className="text-xl font-semibold text-slate-900 mt-8">Usage</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold text-slate-900 mt-8">Sharing</h2>
        <p>
        ...
        <p>
          These disclosures may be required for us to provide you access to our services and
        ...
        <h2 className="text-xl font-semibold text-slate-900 mt-8">Security Precautions</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold text-slate-900 mt-8">Data Deletion and Retention</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold text-slate-900 mt-8">Your Rights</h2>
        <p>
          You may access, rectify, and update your personal data directly through the functionalities
          provided on the Platform.
        </p>

        <h2 className="text-xl font-semibold text-slate-900 mt-8">Consent</h2>
        <p>
        ...
        <h2 className="text-xl font-semibold text-slate-900 mt-8">Changes to this Privacy Policy</h2>
        <p>
          ...
          about the significant changes to the Privacy Policy, in the manner as may be required under applicable laws.
        </p>

        <div className="bg-slate-50 p-6 rounded-lg mt-8 border border-slate-100">
          <h2 className="text-xl font-semibold text-slate-900 mb-4">Grievance Officer & Contact</h2>
          <ul className="space-y-2">
            <li><strong>Company:</strong> Raj Electronics</li>
            <li><strong>Address:</strong> 7-1-949, Rashtrapati Rd, Beside Uggra Laxmi Narsimha Swamy Temple, Secunderabad, Telangana 500003</li>
            <li><strong>Phone:</strong> +91 92907 48866</li>
            <li><strong>Time:</strong> Monday - Sunday (10:30 AM - 9:30 PM)</li>
          </ul>
        </div>
      </div>
    </div>
