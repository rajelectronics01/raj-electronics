...
export default function TermsAndConditions() {
  return (
    <div className="container mx-auto px-4 py-12 max-w-4xl">
      <h1 className="text-3xl md:text-4xl font-bold mb-8 text-slate-900 border-b pb-4">Terms & Conditions</h1>
      ...
      <div className="prose prose-slate max-w-none text-slate-700 space-y-6">
        ...
        <p>
          ...
          ('Website'), including the related mobile site and mobile application https://rajelectronics.co/
          (hereinafter referred to as 'Platform').
        </p>

        <p>
          The Platform is owned by <strong>Raj Electronics</strong>, a company incorporated under the Companies Act, 1956
          with its registered office at 7-1-949, RP road secunderabad, Hyderabad, Telangana 500003
